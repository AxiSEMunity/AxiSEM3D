...
mkdir -p build && cd $_
```
It is good practice to put nothing under this directory except those created by `cmake` and `make`, because it must be emptied before redoing `cmake`.
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDE4OTc2MTk4LDM5MzE0NjgyNiwxMTU3OT
