...
```
#### 2.2.  cmake
Before doing `cmake`, one must edit the root variables in `AxiSEM3D/SOLVER/CMakeLists.txt` to point to the dependencies:
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTUzMzYyODEsMTkzNzMyMDk1NywtND
