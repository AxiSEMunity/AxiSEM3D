...
`-Deigen`, `-Dboost`, `-Dfftw`, `-Dmetis`, `-Dnetcdf`| root paths of the dependencies | empty string | If the root is not provided, `cmake` will search under common library folders.
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzc3NjAwMzk1LDM5MzE0NjgyNiwxMTU3OT
