...
`Dflags`|additional compiler flags | empty | Standard flags such as `-O3`, `-DNDEBUG` and `-std=c++1z` will be automatically 
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzNTM3OTEyNSwzOTMxNDY4MjYsMTE1Nz
