...
`Deigen`, `Dboost`, `Dfftw`, `Dmetis`, `Dnetcdf`| root paths of the dependencies | empty string | the root should contain both '\'
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjkwODc3ODgsMzkzMTQ2ODI2LDExNT
