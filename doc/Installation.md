...
`Dflags`|additional compiler flags | empty | Standard flags such as `-O3`, `-DNDEBUG` and `-std=17` will be automatically 
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjI4NzE5NjEsMzkzMTQ2ODI2LDExNT
