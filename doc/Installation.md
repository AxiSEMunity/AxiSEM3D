...
`Dflags`|additional compiler flags | empty | There is no need to specify standard flags such as `-O3` and `-DNDEBUG`.
...
[<< Back to repository](https://github.com/kuangdai/AxiSEM-3D)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQ2Mzk0MzE1LDM5MzE0NjgyNiwxMTU3OT
