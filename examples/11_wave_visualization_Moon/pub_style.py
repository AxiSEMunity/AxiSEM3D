...
STYLE = {
    # Helvetica everywhere for easy editing in Illustrator. Helvetica itself is
    # not installed on the cluster, so fall back to Nimbus Sans — a metrically
    # identical free Helvetica clone Illustrator opens cleanly. pdf.fonttype 42
    # (below) embeds text as editable TrueType rather than outlines.
