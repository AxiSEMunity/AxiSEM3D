...
The way that you do this in AxiSEM3D requires editing the base model (tayak_60km_atm.bm) if you want to change the thickness or effectiveness of the base model. You will need to do this too for any other models or planets or moons that you want to work with. Thankfully, it just consists of changing numbers rather than changing the code.
...
python -m salvus_mesh_lite.interface AxiSEM --basic.model tayak_60km_atm.bm --basic.period 10 --output_filename tayak_atm_10s.e
